...
class StateMachine:
    def __init__(self, ticker_freq):
        ...
        list_bw_lowpass = [-1.705552145544083852968242354108951985836,   0.743655195048865791385139800695469602942, 1.0, 2.0, 1.0]
        gain_bw_lowpass = 0.009525762376195455113925270040908799274
        # 48-52 band stop Butterworth - for EMG
        list_bw_bandstop = [-0.960616192564186621716260106040863320231,  0.919547137907040124105151335243135690689, 1.0, -1.000877940003687793790732030174694955349, 1.0]
        gain_bw_bandstop = 0.959773568953520062052575667621567845345
